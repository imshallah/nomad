...
public class NewSort {
    ...
    public static void main(String[] args) {
        ...
        String sample = "sum=4.3207455E8, num=0, 0=3.5337459E7, comp_nm=A사"
                + "`sum=2.191123E7, num=1, 0=1991930.0, comp_nm=B사"
                + "`sum=8030636.0, num=2, 0=730057.0, comp_nm=C사"
                + "`sum=6.7682255E7, num=3, 0=6152932.0, comp_nm=D사"
                + "`sum=1195123.0, num=4, 0=108647.0, comp_nm=E사";
